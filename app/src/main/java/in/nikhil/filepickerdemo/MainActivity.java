...
package in.nikhil.filepickerdemo;
...
import in.nikhil.filepicker.view.FilePickerDialog;
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    ...
                    case R.id.multiRadio:   //Setting selection mode to multiple selection.
                        ...
                        properties.max_selections = DialogConfigs.DEFAULT_MAX_SELECTION;
                        properties.show_fullscreen = DialogConfigs.DEFAULT_SHOW_FULLSCREEN;
